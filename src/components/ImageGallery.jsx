    ...
    <>
      ...
      {selectedIndex !== null && (
        <div className="fixed inset-0 z-50 flex items-center justify-center px-2">
          ...
          {/* Popup Card */}
          <div className="relative w-full max-w-[90%] sm:max-w-[400px] h-[70vh] sm:h-[500px] bg-white rounded-lg shadow-lg flex items-center justify-center z-40">
            {/* Close Button */}
            <button
          ...
          <button
            onClick={showPrev}
            className="absolute left-2 sm:left-[calc(50%-200px-37px)] top-1/2 transform -translate-y-1/2 w-10 h-10 rounded-full bg-white flex items-center justify-center text-black shadow hover:bg-gray-100 z-50"
          >
            <ChevronLeft size={20} />
          </button>
          ...
          <button
            onClick={showNext}
            className="absolute right-2 sm:right-[calc(50%-200px-37px)] top-1/2 transform -translate-y-1/2 w-10 h-10 rounded-full bg-white flex items-center justify-center text-black shadow hover:bg-gray-100 z-50"
          >
